...
import Cardsection from "../../Components/CardSection.jsx/Cardsection";
          ...
          <Row>
            <Col>
              ...
              <h4 className="testamonialSubHeading">
                People are leveraging RFM Official to fuel and amplify their
                creative potential.
              </h4>
            </Col>
          </Row>
            ...
            {testimonials.map((t, index) => (
              <div key={t.profile} className="col-lg-3">
                <Row className="align-items-center TestamonialMain my-3">
                  <img
                    src={t.profile}
                    className={`col-3 col-lg-12 testamonialImage ${
                      index === 1 || index === 3 ? "order-lg-1 order-2" : ""
                    }`}
                    height="250px"
                    width="250px"
                    alt=""
                  />
                  <h6
                    className={` col-9 col-lg-12 testamonialImageHeading  ${
                      index === 1 || index === 3 ? "order-lg-1 order-1" : ""
                    }`}
                  >
                    "{t.heading}
                  </h6>
